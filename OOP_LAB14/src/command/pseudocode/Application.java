...
public class Application {
	...
	public static void main(String[] args) {
		...
		app.activeEditor.replaceSelection("TuanNguyen");
		System.out.println("selection của editor0 sau khi chọn \"TuanNguyen\": " + app.activeEditor.getSelection());
		...
		app.undoButton.onClick();
		System.out.println("selection của editor1 sau khi bấm nút undo: " + app.activeEditor.getSelection());
		app.activeEditor.replaceSelection("Entee");
		System.out.println("selection của editor1 sau khi chọn \"Entee\": " + app.activeEditor.getSelection());
		...
		System.out.println(
				"selection của editor0 sau khi bấm tổ hợp phím Ctrl+V: " + app.activeEditor.getSelection());
		app.shortcuts.onPress("Ctrl+X");
		System.out.println(
				"selection của editor0 sau khi bấm tổ hợp phím Ctrl+X: " + app.activeEditor.getSelection());
		app.shortcuts.onPress("Ctrl+Z");
		System.out.println(
				"selection của editor0 sau khi bấm tổ hợp phím Ctrl+Z: " + app.activeEditor.getSelection());
